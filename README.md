...
LLM 接入统一在一个设置入口：15 个内置供应商预设与自定义 Base URL，模型列表拉取失败可手动填写，连接测试分“服务可达”与“模型连接可用”两级展示，密钥保存在操作系统凭据存储。AI 安全检查、描述翻译、语义重复分析、联网搜索辅助四项能力默认关闭、逐项开关并说明发送范围，详见 [LLM 用户配置与隐私说明](docs/llm/用户配置与隐私说明-2026-09-10.md)。
...
- [安装说明](docs/install/)
- [LLM 用户配置与隐私说明](docs/llm/用户配置与隐私说明-2026-09-10.md)
- [LLM 供应商兼容矩阵](docs/llm/供应商兼容矩阵-2026-09-10.md)
