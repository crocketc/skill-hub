...
const RelationshipsGovernanceHistoryPage = lazy(() => import("../features/relationships/RelationshipsPages").then((m) => ({ default: m.RelationshipsGovernanceHistoryPage })));
...
export const appRouter = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "relationships/governance/history", element: <RouteSuspense><RelationshipsGovernanceHistoryPage /></RouteSuspense> },
      // AR-012：发现主页 + 每种发现方式的独立子页（本机/在线/仓库/手动来源）。
      ...
      { path: "discovery/manual", element: <DiscoveryRoute view="manual" /> },
