...
const WORKBENCH_SNAPSHOT: DiscoverySnapshot = {
  ...
  logical_targets: [
    ...
    {
      id: "lt-codebuddy",
      profile_id: "codebuddy",
      client_id: "codebuddy-code",
      scope: "global",
      path: "C:/Users/demo/.codebuddy/skills",
      marker: "SKILL.md",
      precedence: "preferred",
      shared_reference: false,
      exists: true,
  ...
  physical_targets: [
    {
      ...
      logical_target_ids: ["lt-agents-generic", "lt-agents-zcode", "lt-agents-zcode-cli"],
    },
    {
      id: "phys-codebuddy",
      path: "C:/Users/demo/.codebuddy/skills",
      ...
      writable: true,
      case_behavior: "sensitive",
      logical_target_ids: ["lt-codebuddy"],
    },
    {
      id: "phys-claude",
      path: "C:/Users/demo/.claude/skills",
