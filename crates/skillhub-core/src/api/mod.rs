...
pub use command::{
    ...
    PrepareUninstall, ReadSharedProjectConfig, RecheckBasic, RecheckLlmSafety, RefreshSkillRepo,
    RegisterProject, RelinkSource, RemoveCustomAgent, RemoveIgnoreRule, RemoveSkillRepo,
    RenameCombination, RenameSkill, RescanSkill, ResetProfileOverride, ResolveRecovery,
