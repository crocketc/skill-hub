...
浏览器自动化不能替代真实桌面人工验收：真实 Tauri IPC/数据库持久化、操作系统文件选择器和文件管理器、真实文件系统读写、真实 GitHub/网络、AI 运行与取消、备份恢复文件内容、跨平台安装包及签名更新回滚，仍须按 `docs/development/人工验收清单-2026-09-10.md` 取证。浏览器验收的当前范围和结果见 `docs/development/自动化测试说明-2026-09-10.md`。
